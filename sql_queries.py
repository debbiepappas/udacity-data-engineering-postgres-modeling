...
songplays (songplay_id SERIAL PRIMARY KEY, start_time bigint NOT NULL, user_id int NOT NULL, \
level varchar, song_id varchar, artist_id varchar, session_id int NOT NULL, \
...
songs (song_id varchar, title text NOT NULL, artist_id varchar NOT NULL, year int NOT NULL, \
...
time (start_time time, hour int NOT NULL, day int NOT NULL, week int NOT NULL, \
